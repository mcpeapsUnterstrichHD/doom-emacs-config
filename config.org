...
- [[#org-mode-settings][Org mode Settings]]
  ...
  - [[#export-with-broken-links][Export with broken Links]]
- [[#eglot][Eglot]]
...
Verhindert, dass Projectile das gesamte Home-Verzeichnis als Projekt scannt,
falls dort ein (verwaister) .git Ordner oder Symlink liegt.
